...
# docker build -t compound_stack_rails .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name compound_stack_rails compound_stack_rails
