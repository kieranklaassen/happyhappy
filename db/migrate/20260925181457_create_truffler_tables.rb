class CreateTrufflerTables < ActiveRecord::Migration[8.1]
  def change
    ...
    create_table :truffler_lenses do |t|
      t.string :record_type, null: false
      t.string :scope_type, null: false, default: "app"
      t.string :scope_key
      t.string :tenant_key
